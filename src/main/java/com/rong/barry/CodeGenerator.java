...
import com.rong.barry.generator.config.GeneratorConstants;
...
//                .packInclude("com.rong.barry.entity") // 批量加入生成的实体类包名
    ...
    public CodeGenerator(String configLocation) {
        try {
            ...
            config.setFtlPath(properties.getProperty("template.dir",
                    GeneratorConstants.SRC_PATH_PREFIX + "resources/templates/"));
            ...
            config.setBaseProjectPath(
                    properties.getProperty("base.project.path", GeneratorConstants.SRC_PATH_PREFIX + "java"));
            // 实体的主键
